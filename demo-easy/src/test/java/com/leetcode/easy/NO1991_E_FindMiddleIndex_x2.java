...
public class NO1991_E_FindMiddleIndex_x2 {
    ...
    @Test
    public void test() {
        assert  3 == findMiddleIndex(new int[]{2, 3, -1, 8, 4});
        assert  2 == findMiddleIndex(new int[]{1, -1, 4});
        assert -1 == findMiddleIndex(new int[]{2, 5});
        assert  0 == findMiddleIndex(new int[]{1});
    }
