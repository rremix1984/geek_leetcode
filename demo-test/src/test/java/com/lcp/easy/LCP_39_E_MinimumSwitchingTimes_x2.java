...
*/
public class LCP_39_E_MinimumSwitchingTimes_x2 {

    @Test
    public void test() {
        assert 1 == minimumSwitchingTimes(
            new int[][]{{1, 3}, {5, 4}}, new int[][]{{3, 1}, {6, 5}});
        assert 0 == minimumSwitchingTimes(
            new int[][]{{1, 2, 3}, {3, 4, 5}}, new int[][]{{1, 3, 5}, {2, 3, 4}});
    }
