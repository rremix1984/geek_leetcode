...
public class NO1143_N_LongestCommonSubsequence_x2 {

    @Test
    public void test() {
        assert 3 == longestCommonSubsequence("abc","abc");// 3
        assert 3 == longestCommonSubsequence("abcde", "ace");// 3
        assert 0 == longestCommonSubsequence("abc", "def");// 0
    }
