...
*/
public class Offer_068_II_E_LowestCommonAncestor_x2 {

    @Test
    public void test() {
        TreeNode<Integer> t1 = cTree(3,  5,  1,  6,  2,  0,  8,  null,  null,  7,  4);
        assert t1 == lowestCommonAncestor(t1,  t1.left,  t1.right);
        TreeNode<Integer> t2 = cTree(3,  5,  1,  6,  2,  0,  8,  null,  null,  7,  4);
