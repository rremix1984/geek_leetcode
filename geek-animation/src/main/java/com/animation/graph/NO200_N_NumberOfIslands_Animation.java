...
public class NO200_N_NumberOfIslands_Animation extends JFrame {
    ...
    private void startAnimation() {
        new Timer().schedule(new TimerTask() {
            ...
            public void run() {
                if (r >= rows) {
                    statusLabel.setText("总共发现 " + islandCount + " 个岛屿。");
                    this.cancel();
                    return;
                }
                ...
                if (grid[r][c] == '1' && !visited[r][c]) {
                    islandCount++;
                    statusLabel.setText("在 (" + r + ", " + c + ") 发现新岛屿，当前岛屿数: " + islandCount);
                    dfs(r, c);
                }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new NO200_N_NumberOfIslands_Animation().setVisible(true));
    }
}