...
public class AlgorithmTreeLauncher extends JFrame {
    ...
    private void initAnimations() {
        ...
        animations.put("Binary Tree Top View", () -> new com.animation.tree.BinaryTreeTopView_Animation().setVisible(true));
        animations.put("Interval 02 05 N Add Two Numbers", () -> new com.animation.interval.Interval_02_05_N_AddTwoNumbers_Animation().setVisible(true));
        animations.put("Interval 04 05 N Is Valid BST", () -> new com.animation.interval.Interval_04_05_N_IsValidBST_Animation().setVisible(true));
        animations.put("Interval 04 06 N Inorder Successor", () -> new com.animation.interval.Interval_04_06_N_InorderSuccessor_Animation().setVisible(true));
        animations.put("Interval 04 10 N Check Sub Tree", () -> new com.animation.interval.Interval_04_10_N_CheckSubTree_Animation().setVisible(true));
        animations.put("Interval 04 12 N Path Sum", () -> new com.animation.interval.Interval_04_12_N_PathSum_Animation().setVisible(true));
        animations.put("Interval 08 09 N Generate Parenthesis", () -> new com.animation.interval.Interval_08_09_N_GenerateParenthesis_Animation().setVisible(true));
        animations.put("NO.001 Two Sum", () -> new com.animation.array.NO001_E_TwoSum_Animation().setVisible(true));
        animations.put("NO.005 N Longest Palindromic Substring", () -> new com.animation.normal.NO005_N_LongestPalindromicSubstring_Animation().setVisible(true));
        animations.put("NO.009 Is Palindrome", () -> new com.animation.math.NO009_E_IsPalindrome_Animation().setVisible(true));
        animations.put("NO.015 N Three Sum", () -> new com.animation.normal.NO015_N_ThreeSum_Animation().setVisible(true));
        animations.put("NO.023 Merge KSorted Lists", () -> new com.animation.hard.NO023_H_MergeKSortedLists_Animation().setVisible(true));
        animations.put("NO.026 Remove Duplicates From Sorted Array", () -> new com.animation.array.NO026_E_RemoveDuplicatesFromSortedArray_Animation().setVisible(true));
        animations.put("NO.027 Remove Element", () -> new com.animation.array.NO027_E_RemoveElement_Animation().setVisible(true));
        animations.put("NO.035 Search Insert", () -> new com.animation.search.NO035_E_SearchInsert_Animation().setVisible(true));
        animations.put("NO.045 N Jump Game II", () -> new com.animation.greedy.NO045_N_JumpGameII_Animation().setVisible(true));
        animations.put("NO.046 N Permutations", () -> new com.animation.normal.NO046_N_Permutations_Animation().setVisible(true));
        animations.put("NO.047 N Permutations II", () -> new com.animation.normal.NO047_N_PermutationsII_Animation().setVisible(true));
        animations.put("NO.053 N Maximum Subarray", () -> new com.animation.normal.NO053_N_MaximumSubarray_Animation().setVisible(true));
        animations.put("NO.055 Jump Game", () -> new com.animation.greedy.NO055_E_JumpGame_Animation().setVisible(true));
        animations.put("NO.055 N Jump Game", () -> new com.animation.greedy.NO055_N_JumpGame_Animation().setVisible(true));
        animations.put("NO.066 Plus One", () -> new com.animation.math.NO066_E_PlusOne_Animation().setVisible(true));
        animations.put("NO.069 Sqrt X", () -> new com.animation.math.NO069_E_SqrtX_Animation().setVisible(true));
        animations.put("NO.088 Merge Sorted Array", () -> new com.animation.array.NO088_E_MergeSortedArray_Animation().setVisible(true));
        animations.put("NO.094 Inorder Traversal", () -> new com.animation.tree.NO094_E_InorderTraversal_Animation().setVisible(true));
        animations.put("NO.10 Binary Tree", () -> new com.animation.lonch.NO10_BinaryTree_Animation().setVisible(true));
        animations.put("NO.100 Is Same Tree", () -> new com.animation.tree.NO100_E_IsSameTree_Animation().setVisible(true));
        animations.put("NO.1002 Common Chars", () -> new com.animation.string.NO1002_E_CommonChars_Animation().setVisible(true));
        animations.put("NO.1005 Largest Sum After KNegations", () -> new com.animation.greedy.NO1005_E_LargestSumAfterKNegations_Animation().setVisible(true));
        animations.put("NO.101 Is Symmetric", () -> new com.animation.tree.NO101_E_IsSymmetric_Animation().setVisible(true));
        animations.put("NO.104 Maximum Depth Of Binary Tree", () -> new com.animation.tree.NO104_E_MaximumDepthOfBinaryTree_Animation().setVisible(true));
        animations.put("NO.1051 Height Checker", () -> new com.animation.array.NO1051_E_HeightChecker_Animation().setVisible(true));
        animations.put("NO.108 Sorted Array To BST", () -> new com.animation.tree.NO108_E_SortedArrayToBST_Animation().setVisible(true));
        animations.put("NO.11 Binary Tree Traversal", () -> new com.animation.lonch.NO11_BinaryTreeTraversal_Animation().setVisible(true));
        animations.put("NO.112 Has Path Sum", () -> new com.animation.tree.NO112_E_HasPathSum_Animation().setVisible(true));
        animations.put("NO.118 Generate", () -> new com.animation.dp.NO118_E_Generate_Animation().setVisible(true));
        animations.put("NO.1206 Skiplist", () -> new com.animation.hard.NO1206_H_Skiplist_Animation().setVisible(true));
        animations.put("NO.121 Best Time To Buy And Sell Stock", () -> new com.animation.greedy.NO121_E_BestTimeToBuyAndSellStock_Animation().setVisible(true));
        animations.put("NO.1235 Job Scheduling", () -> new com.animation.hard.NO1235_H_JobScheduling_Animation().setVisible(true));
        animations.put("NO.126 Word Ladder II", () -> new com.animation.hard.NO126_H_WordLadderII_Animation().setVisible(true));
        animations.put("NO.1266 Min Time To Visit All Points", () -> new com.animation.easy.NO1266_E_MinTimeToVisitAllPoints_Animation().setVisible(true));
        animations.put("NO.127 Word Ladder", () -> new com.animation.hard.NO127_H_WordLadder_Animation().setVisible(true));
        animations.put("NO.1306 N Jump Game III", () -> new com.animation.dfs.NO1306_N_JumpGameIII_Animation().setVisible(true));
        animations.put("NO.136 Single Number", () -> new com.animation.bit.NO136_E_SingleNumber_Animation().setVisible(true));
        animations.put("NO.139 N Word Break", () -> new com.animation.normal.NO139_N_WordBreak_Animation().setVisible(true));
        animations.put("NO.144 Preorder Traversal", () -> new com.animation.tree.NO144_E_PreorderTraversal_Animation().setVisible(true));
        animations.put("NO.145 Postorder Traversal", () -> new com.animation.tree.NO145_E_PostorderTraversal_Animation().setVisible(true));
        animations.put("NO.1654 N Minimum Jumps", () -> new com.animation.bfs.NO1654_N_MinimumJumps_Animation().setVisible(true));
        animations.put("NO.190 Reverse Bits", () -> new com.animation.bit.NO190_E_ReverseBits_Animation().setVisible(true));
        animations.put("NO.199 N Binary Tree Right Side View", () -> new com.animation.tree.NO199_N_BinaryTreeRightSideView_Animation().setVisible(true));
        animations.put("NO.200 N Number Of Islands", () -> new com.animation.graph.NO200_N_NumberOfIslands_Animation().setVisible(true));
        animations.put("NO.200 N Number Of Islands", () -> new com.animation.normal.NO200_N_NumberOfIslands_Animation().setVisible(true));
        animations.put("NO.207 Course Schedule", () -> new com.animation.graph.NO207_M_CourseSchedule_Animation().setVisible(true));
        animations.put("NO.208 N Trie", () -> new com.animation.normal.NO208_N_Trie_Animation().setVisible(true));
        animations.put("NO.211 N Word Dictionary", () -> new com.animation.normal.NO211_N_WordDictionary_Animation().setVisible(true));
        animations.put("NO.225 My Stack", () -> new com.animation.datastructure.NO225_E_MyStack_Animation().setVisible(true));
        animations.put("NO.225 My Stack", () -> new com.animation.stack.NO225_E_MyStack_Animation().setVisible(true));
        animations.put("NO.234 Palindrome Linked List", () -> new com.animation.datastructure.NO234_E_PalindromeLinkedList_Animation().setVisible(true));
        animations.put("NO.2498 N Max Jump", () -> new com.animation.greedy.NO2498_N_MaxJump_Animation().setVisible(true));
        animations.put("NO.2529 Maximum Count", () -> new com.animation.array.NO2529_E_MaximumCount_Animation().setVisible(true));
        animations.put("NO.2535 Difference Of Sum", () -> new com.animation.array.NO2535_E_DifferenceOfSum_Animation().setVisible(true));
        animations.put("NO.2540 Get Common", () -> new com.animation.array.NO2540_E_GetCommon_Animation().setVisible(true));
        animations.put("NO.2549 Distinct Integers", () -> new com.animation.math.NO2549_E_DistinctIntegers_Animation().setVisible(true));
        animations.put("NO.2553 Separate Digits", () -> new com.animation.array.NO2553_E_SeparateDigits_Animation().setVisible(true));
        animations.put("NO.2558 Pick Gifts", () -> new com.animation.greedy.NO2558_E_PickGifts_Animation().setVisible(true));
        animations.put("NO.2558 Pick Gifts", () -> new com.animation.heap.NO2558_E_PickGifts_Animation().setVisible(true));
        animations.put("NO.2562 Find The Array Conc Val", () -> new com.animation.array.NO2562_E_FindTheArrayConcVal_Animation().setVisible(true));
        animations.put("NO.2570 Merge Arrays", () -> new com.animation.array.NO2570_E_MergeArrays_Animation().setVisible(true));
        animations.put("NO.2574 Left Right Difference", () -> new com.animation.array.NO2574_E_LeftRightDifference_Animation().setVisible(true));
        animations.put("NO.2586 Vowel Strings", () -> new com.animation.array.NO2586_E_VowelStrings_Animation().setVisible(true));
        animations.put("NO.2706 Buy Choco", () -> new com.animation.greedy.NO2706_E_BuyChoco_Animation().setVisible(true));
        animations.put("NO.2733 Find Non Min Or Max", () -> new com.animation.array.NO2733_E_FindNonMinOrMax_Animation().setVisible(true));
        animations.put("NO.2824 Count Pairs", () -> new com.animation.array.NO2824_E_CountPairs_Animation().setVisible(true));
        animations.put("NO.2828 Is Acronym", () -> new com.animation.string.NO2828_E_IsAcronym_Animation().setVisible(true));
        animations.put("NO.283 Move Zeroes", () -> new com.animation.array.NO283_E_MoveZeroes_Animation().setVisible(true));
        animations.put("NO.284 N Peeking Iterator", () -> new com.animation.normal.NO284_N_PeekingIterator_Animation().setVisible(true));
        animations.put("NO.2859 Sum Indices With KSet Bits", () -> new com.animation.array.NO2859_E_SumIndicesWithKSetBits_Animation().setVisible(true));
        animations.put("NO.2942 Find Words Containing", () -> new com.animation.string.NO2942_E_FindWordsContaining_Animation().setVisible(true));
        animations.put("NO.297 Serialize And Deserialize Binary Tree", () -> new com.animation.hard.NO297_H_SerializeAndDeserializeBinaryTree_Animation().setVisible(true));
        animations.put("NO.312 Burst Balloons", () -> new com.animation.hard.NO312_H_BurstBalloons_Animation().setVisible(true));
        animations.put("NO.322 N Coin Change", () -> new com.animation.normal.NO322_N_CoinChange_Animation().setVisible(true));
        animations.put("NO.403 Frog Jump", () -> new com.animation.hard.NO403_H_FrogJump_Animation().setVisible(true));
        animations.put("NO.463 Island Perimeter", () -> new com.animation.graph.NO463_E_IslandPerimeter_Animation().setVisible(true));
        animations.put("NO.51 NQueens", () -> new com.animation.hard.NO51_H_NQueens_Animation().setVisible(true));
        animations.put("NO.52 NQueens II", () -> new com.animation.hard.NO52_H_NQueensII_Animation(8).setVisible(true));
        animations.put("NO.695 N Max Area Of Island", () -> new com.animation.graph.NO695_N_MaxAreaOfIsland_Animation().setVisible(true));
        animations.put("NO.703 Kth Largest", () -> new com.animation.datastructure.NO703_E_KthLargest_Animation().setVisible(true));
        animations.put("NO.704 Binary Search", () -> new com.animation.search.NO704_E_BinarySearch_Animation().setVisible(true));
        animations.put("NO.705 My Hash Set", () -> new com.animation.datastructure.NO705_E_MyHashSet_Animation().setVisible(true));
        animations.put("NO.706 My Hash Map", () -> new com.animation.datastructure.NO706_E_MyHashMap_Animation().setVisible(true));
        animations.put("NO.764 N Order Of Largest Plus Sign", () -> new com.animation.normal.NO764_N_OrderOfLargestPlusSign_Animation().setVisible(true));
        animations.put("NO.773 Sliding Puzzle", () -> new com.animation.hard.NO773_H_SlidingPuzzle_Animation().setVisible(true));
        animations.put("NO.784 N Letter Case Permutation", () -> new com.animation.normal.NO784_N_LetterCasePermutation_Animation().setVisible(true));
        animations.put("NO.834 Sum Of Distances In Tree", () -> new com.animation.hard.NO834_H_SumOfDistancesInTree_Animation().setVisible(true));
        animations.put("NO.85 Maximal Rectangle", () -> new com.animation.hard.NO85_H_MaximalRectangle_Animation().setVisible(true));
        animations.put("NO.882 Reachable Nodes", () -> new com.animation.hard.NO882_H_ReachableNodes_Animation().setVisible(true));
        animations.put("NO.9 Snake Game", () -> new com.animation.lonch.NO9_SnakeGame_Animation().setVisible(true));
        animations.put("NO.915 N Partition Disjoint", () -> new com.animation.normal.NO915_N_PartitionDisjoint_Animation().setVisible(true));
        animations.put("NO.977 Sorted Squares", () -> new com.animation.array.NO977_E_SortedSquares_Animation().setVisible(true));
        animations.put("NO.994 N Rotting Oranges", () -> new com.animation.graph.NO994_N_RottingOranges_Animation().setVisible(true));
