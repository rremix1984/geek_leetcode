...
/**
    ...
    思路与算法：
        为了计算第 kk 个人买完票所需的时间，我们可以首先计算在这个过程中每个人买票所需要的时间，再对这些时间求和得到答案。
        我们可以对每个人的下标 i 分类讨论：
            1）如果这个人初始在第 k 个人的前方，或者这个人恰好为第 k 个人，即 i ≤ k，
               此时在第 k 个人买完票之前他最多可以购买 tickets[k] 张。
               考虑到他想要购买的票数，那么他买票所需时间即为 min(tickets[k], tickets[i])；
            2）如果这个人初始在第 k 个人的后方，即 i > k，此时在第 k 个人买完票之前他最多可以购买 [k]−1 张。
               考虑到他想要购买的票数，那么他买票所需时间即为 min(tickets[k] − 1, tickets[i])。
        我们遍历每个人的下标，按照上述方式计算并维护每个人买票所需时间之和，即可得到第 kk 个人买完票所需的时间，我们返回该值作为答案。
*/
public class NO2073_E_TimeRequiredToBuy_x2 {
