...
*/
public class NO2164_E_SortEvenOdd {

    @Test
    public void test() {
        assertArrayEquals(new int[]{2, 3, 4, 1},
            sortEvenOdd(new int[]{4, 1, 2, 3}));
        assertArrayEquals(new int[]{2, 1},
            sortEvenOdd(new int[]{2, 1}));
    }
