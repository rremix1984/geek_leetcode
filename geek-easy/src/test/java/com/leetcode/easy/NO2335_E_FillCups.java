...
/**
    ...
    示例 1：
        ...
        输出：4
        解释：下面给出一种方案：
             第 1 秒：  装满 1 杯冷水和 1 杯温水。
             第 2-3 秒：装满 2 杯温水和 2 杯热水。
             第 4 秒：  装满 1 杯温水。
    ...
    1）题解：
        ...
        当x < y + z, 就得平均使用y和z去与x配对，即y与z哪个数大就用哪个去和x配对，在消耗x的过程中，【必然会出现z = y的时候】，
        在此之后，z 和 y 交替与 x 配对，直至x = 0。这时y与z是相等的或者相差1，那么y与z再配对，最后要么刚好配对完，要么只剩一个单杯。
        即 x + ⌈(y + z - x) / 2⌉。

    2）说明第二种情况为什么会必然出现 z = y
