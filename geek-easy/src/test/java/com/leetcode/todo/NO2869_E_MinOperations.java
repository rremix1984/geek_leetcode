...
public class NO2869_E_MinOperations {
    ...
    @Test
    public void test() {
        assert 4 == minOperations(getArray(3,1,5,4,2), 2);
        assert 4 == minOperations(getArray(3,2,5,3,1), 3);
        assert 5 == minOperations(getArray(3,1,5,4,2), 5);
    }
