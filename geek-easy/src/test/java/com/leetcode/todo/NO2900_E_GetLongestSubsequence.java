...
public class NO2900_E_GetLongestSubsequence {
    ...
    @Test
    public void test() {
        assert getArray("a", "b", "c").equals(
            getLongestSubsequence(4, new String[]{"a","b","c","d"}, new int[]{1,0,1,1}));
        assert getArray("e", "b").equals(
            getLongestSubsequence(3, new String[]{"e","a","b"}, new int[]{0,0,1}));
    }
