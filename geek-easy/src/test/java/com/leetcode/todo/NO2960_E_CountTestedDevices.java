...
*/
public class NO2960_E_CountTestedDevices {

    @Test
    public void test() {
        assert 3 == countTestedDevices(new int[]{1, 1, 2, 1, 3});
        assert 2 == countTestedDevices(new int[]{0, 1, 2});
    }
