...
*/
public class NO1763_E_LongestNiceSubstring {

    @Test
    public void test() {
        assert "aAa".equals(longestNiceSubstring("YazaAay"));
        assert "Bb".equals(longestNiceSubstring("Bb"));
        assert "".equals(longestNiceSubstring("c"));
        assert "dD".equals(longestNiceSubstring("dDzeE"));
    }
