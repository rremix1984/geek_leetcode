...
public class NO882_H_ReachableNodes {
    ...
    @Test
    public void test() {
        assert 13 == reachableNodes(new int[][]{{0,1,10},{0,2,1},{1,2,2}}, 6, 3);
        assert 23 == reachableNodes(new int[][]{{0,1,4},{1,2,6},{0,2,8},{1,3,1}}, 10, 4);
        assert 1 == reachableNodes(new int[][]{{1,2,4},{1,4,5},{1,3,1},{2,3,4},{3,4,5}}, 17, 5);
    }
