...
public class AccumulatorCompareDemo {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        out.println("----costTime: " + (endTime - startTime) + " 毫秒" + "\t clickBySynchronized: " + clickNumber.number);
        ...
        endTime = System.currentTimeMillis();
        out.println("----costTime: " + (endTime - startTime) + " 毫秒" + "\t clickByLongAdder: " + clickNumber.longAdder.sum());
