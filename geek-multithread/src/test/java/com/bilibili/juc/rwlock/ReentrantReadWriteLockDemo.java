...
class MyResource {//资源类，模拟一个简单的缓存
    ...
    public void write(String key, String value) {
        ...
        try {
            out.println(Thread.currentThread().getName() + "\t" + "正在写入");
            map.put(key, value);
            //暂停毫秒
            try {
            ...
            out.println(Thread.currentThread().getName() + "\t" + "完成写入");
        } finally {
    ...
    public void read(String key) {
        ...
        try {
            out.println(Thread.currentThread().getName() + "\t" + "正在读取");
            ...
            out.println(Thread.currentThread().getName() + "\t" + "完成读取" + "\t" + result);
        } finally {
