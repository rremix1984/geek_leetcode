...
/**
    (中等)
    223. 矩形面积
        给你 二维 平面上两个 由直线构成且边与坐标轴平行/垂直 的矩形，
        请你计算并返回两个矩形覆盖的总面积。
...
*/
public class NO223_N_ComputeArea {

    @Test
    public void test() {
        assert 45 == computeArea(-3, 0, 3, 4,
                                0, -1, 9, 2);
        assert 16 == computeArea(-2, -2, 2, 2,
                                -2, -2, 2, 2);
    }
