...
*/
public class NO241_N_DiffWaysToCompute {

    @Test
    public void test() {
        assert getArray(2,0).equals(diffWaysToCompute("2-1-1"));
        assert getArray(-34,-10,-14,-10,10).equals(diffWaysToCompute("2*3-4*5"));
    }
